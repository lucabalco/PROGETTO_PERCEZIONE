...
# Visualizzazione BMI senza contorno delle barre e con spazio tra barre
plt.figure(figsize=(6, 4))
sns.histplot(
    df['BMI'],
    bins=30,
    color="#12B22D",
    edgecolor=None,  # rimuove contorno nero
    shrink=0.9       # lascia uno spazio tra le barre
)

plt.title('BMI', fontsize=12)
...
plt.tick_params(bottom=False, left=False)  # rimuove stanghette sui tick
